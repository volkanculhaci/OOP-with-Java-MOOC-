...
public class DivisionTest {
    ...
    public void test1() throws Throwable {
        ...
        Reflex.reflect(Division.class).staticMethod("division").returningVoid().taking(int.class, int.class).invoke(2,
                1);
    ...
    public void test2() throws Throwable {
        int oldOut = io.getSysOut().length();
        Reflex.reflect(Division.class).staticMethod("division").returningVoid().taking(int.class, int.class).invoke(7,
                2);
        String out = io.getSysOut().substring(oldOut);
